...
public class FrontendCustomContentLimitedData {
    ...
    public FrontendCustomContentLimitedData(Integer id, Integer contentId, String publishDate, Integer isActive, Integer isUpcoming, Integer sortingPosition, Integer frontendCustomContentTypeId, Object createdAt, Object updatedAt, OttContent ottContent) {
        this.id = id;
